...
# execute the command
print "cp *.fasta.out ./RM_37479.FriJan41356312019"
os.system("cp *.fasta.out ./RM_37479.FriJan41356312019")
os.system("/storage/home/users/pjt6/shelf_apps/apps/one_code/build_dictionary.pl --rm ./RM_37479.FriJan41356312019 --fuzzy > Hs_fuzzy.txt")

print "/storage/home/users/pjt6/shelf_apps/apps/one_code/build_dictionary.pl --rm ./RM_37479.FriJan41356312019 --fuzzy > Hs_fuzzy.txt"
os.system("/storage/home/users/pjt6/shelf_apps/apps/one_code/build_dictionary.pl --rm ./RM_37479.FriJan41356312019 --fuzzy > Hs_fuzzy.txt")
#/storage/home/users/pjt6/shelf_apps/apps/one_code/build_dictionary.pl --rm ./RM_37479.FriJan41356312019 --fuzzy > Hs_fuzzy.txt
 
#/storage/home/users/pjt6/shelf_apps/apps/one_code/OneCodeToFindThemAll.pl --dir /shelf/apps/pjt6/Hsh/repeatmasking/RM_37479.FriJan41356312019/ --rm ./RM_37479.FriJan41356312019/Hs.fasta.out --ltr Hs_fuzzy.txt --fasta 


print "/storage/home/users/pjt6/shelf_apps/apps/one_code/OneCodeToFindThemAll.pl --dir /shelf/apps/pjt6/Hsh/repeatmasking/RM_37479.FriJan41356312019/ --rm ./RM_37479.FriJan41356312019/Hs.fasta.out --ltr Hs_fuzzy.txt --fasta"
os.system("/storage/home/users/pjt6/shelf_apps/apps/one_code/OneCodeToFindThemAll.pl --dir /shelf/apps/pjt6/Hsh/repeatmasking/RM_37479.FriJan41356312019/ --rm ./RM_37479.FriJan41356312019/Hs.fasta.out --ltr Hs_fuzzy.txt --fasta")
...
TEs_from_OCFA, serial = parse_ocfa_elem_stored('/shelf/apps/pjt6/Hsh/repeatmasking/RM_37479.FriJan41356312019/')
#
...
TEs, serial = integrate_ltrharvest_to_RM_TEs('/shelf/apps/pjt6/Hsh/repeatmasking/Hs_LTR_harvest.out',      
                                              '/shelf/apps/pjt6/Hsh/repeatmasking/Hs.fasta',  
                                              TEs_from_OCFA,
                                             serial)
...
TEs = integrate_TransposonPSI_to_RM_TEs('/shelf/apps/pjt6/Hsh/repeatmasking/Hs.fasta.TPSI.allHits.chains.bestPerLocus', 
                                         '/shelf/apps/pjt6/Hsh/repeatmasking/Hs.fasta', 
                                         TEs, 
                                         serial)
...
write_gff(TEs, 'Hetero_scha.transposable_elements.gff3', max_RM_OC_score=False)
